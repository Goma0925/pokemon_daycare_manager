...
<div class="card text-center">
    ...
    <div class="card-body">
        ...
        <h2>
            <?php 
                if (!isset($_GET["redirect-to"]) || $_GET["redirect-to"]=="check-in-pokemon"){
                    ...
                    echo "Select a service record to check-out";
                }
            ?>
        </h2>
        <form method="GET">
        ...
        <?php 
            ...
            //Render the search table for check in
            if (!isset($_GET["redirect-to"]) || $_GET["redirect-to"]=="check-in-pokemon"){
            ...
            //Render a service record list for check-out 
            }else{
                //Define where to jump after selecting a service record.
